...
looping juga disini.
Contoh:
3 => 3, karena sudah satu digit 24 => 8. Karena 24 dua digit, maka kita lakukan
2 * 4 = 8. 8 satu digit, maka hasilnya adalah 8. 654 => 0. Karena 654 tiga digit,
maka lakukan 6 * 5 * 4 = 120. 120 tiga digit, maka lakukan 1 * 2 * 0 = 0.
...
function kaliTerusRekursif(angka) {
    if (angka < 10) {
      ...
      var mod = angka % 10;
      var hasil = (angka - mod) / 10;
      return kaliTerusRekursif(mod * kaliTerusRekursif(hasil));
    }
  }
